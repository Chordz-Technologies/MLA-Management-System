...
export class ChatbotComponent implements OnInit {
  ...
  getBotResponse(message: string): SafeHtml {
    const responses: { [key: string]: string } = {
      ...
      'nivedane, निवेदने, सर्व-निवेदने': 'If you want to add nivedane please refer this : <a href="https://mlawebsite.beatsacademy.in/#/निवेदने" target=_blank>https://mlawebsite.beatsacademy.in/#/निवेदने</a> <br> If you want to see all nivedane please refer this : <a href="https://mlawebsite.beatsacademy.in/#/सर्व-निवेदने" target=_blank>https://mlawebsite.beatsacademy.in/#/सर्व-निवेदने</a>',
