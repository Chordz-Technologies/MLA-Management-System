...
export class AllRecordsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private service: ServiceService, private datePipe: DatePipe, private toastr: ToastrService) { }
  ...
  fetchData(adminId: number): void {
    ...
    this.service.fetchData(adminId, this.selectedDate).subscribe(
      (data) => {
